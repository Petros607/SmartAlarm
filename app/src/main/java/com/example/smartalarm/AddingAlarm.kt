...
//
//                    val pi = PendingIntent.getBroadcast(this, 1, iBroadCast, PendingIntent.FLAG_IMMUTABLE)
//                    var tt = System.currentTimeMillis() + 10*1000
//                    //alarmManager.set(AlarmManager.RTC_WAKEUP, tt, pi)
//                    //alarmManager.setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, selectedCalendar.timeInMillis, getAlarmActionPendingIntent())
//
